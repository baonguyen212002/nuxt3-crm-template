<template>
    <Disclosure as="nav" :class="['bg-gray-800 fixed top-0 left-0 right-0 z-50 transition', { 'shadow': isScrolled }]"
        v-slot="{ open }">
    ...
    <div class="h-16"></div> <!-- Placeholder để tránh nội dung bị che khuất -->
</template>
